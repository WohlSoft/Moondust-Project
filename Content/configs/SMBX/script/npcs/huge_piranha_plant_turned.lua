...
class 'huge_piranha_plant_turned'
...
function huge_piranha_plant_turned:__init(npc_obj)
...
function huge_piranha_plant_turned:onActivated()
    self:initProps()
end

function huge_piranha_plant_turned:onLoop(tickTime)
...
function huge_piranha_plant_turned:onHarm(harmEvent)
    self.cur_keep_showing = false
end

return huge_piranha_plant_turned
