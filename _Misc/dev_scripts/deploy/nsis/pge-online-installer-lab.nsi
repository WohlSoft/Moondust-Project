...
;Output filename
OutFile "pge-dev-online-downloader.exe"

;Window title
Caption "Laboratory PGE Online Installer (wohlsoft.ru mirror)"
...
SubSection "Main components" SubSecComp
	Section "Runtime libraries" SecLibs
		...
		SetOutPath $INSTDIR
		;Download the file
		NSISdl::download "http://wohlsoft.ru/docs/_laboratory/_Builds/win32/bin-w32/_packed/install-pge-common-dev-win32.zip" "common_libs.zip"
	...
	Section "Editor" SecEditor
		...
		SetOutPath $INSTDIR
		;Download the file
		NSISdl::download "http://wohlsoft.ru/docs/_laboratory/_Builds/win32/bin-w32/_packed/install-pge-editor-dev-win32.zip" "editor.zip"
        Pop $R0 ;Get the return value
          StrCmp $R0 "success" +3
            MessageBox MB_OK|MB_ICONSTOP "Download failed: $R0"
            Quit
	...
	Section "Engine [Experimental]" SecEngine
		...
		SetOutPath $INSTDIR
		;Download the file
		NSISdl::download "http://wohlsoft.ru/docs/_laboratory/_Builds/win32/bin-w32/_packed/install-pge-engine-dev-win32.zip" "engine.zip"
        Pop $R0 ;Get the return value
          StrCmp $R0 "success" +3
            MessageBox MB_OK|MB_ICONSTOP "Download failed: $R0"
            Quit
	...
	Section "Additonal console tools" SecTools
		...
		SetOutPath $INSTDIR
		;Download the file
		NSISdl::download "http://wohlsoft.ru/docs/_laboratory/_Builds/win32/bin-w32/_packed/install-pge-tools-dev-win32.zip" "tools.zip"
        Pop $R0 ;Get the return value
          StrCmp $R0 "success" +3
            MessageBox MB_OK|MB_ICONSTOP "Download failed: $R0"
            Quit
...
SubSection "Config Packs (Must select one)" SubSecCfg
	Section "SMBX Integrator" SecInt
		...
		;Download file
		NSISdl::download "http://wohlsoft.ru/docs/_laboratory/config_packs/SMBX_Integration.zip" "SMBXIntegrator.zip"
        Pop $R0 ;Get the return value
          StrCmp $R0 "success" +3
            MessageBox MB_OK|MB_ICONSTOP "Download failed: $R0"
            Quit
	...
	Section "SMBX 1.3 Compatible" SecMBX
		...
		SetOutPath "$INSTDIR\configs\"
		;Download file
		NSISdl::download "http://wohlsoft.ru/docs/_laboratory/config_packs/SMBX_13_compatible.zip" "smbxcfg.zip"
        Pop $R0 ;Get the return value
          StrCmp $R0 "success" +3
            MessageBox MB_OK|MB_ICONSTOP "Download failed: $R0"
            Quit
	...
	Section "Raocow TalkHaus/ASMBXT Config Pack" SecRaocow
		...
		SetOutPath "$INSTDIR\configs"
		;Download the file
		NSISdl::download "http://wohlsoft.ru/docs/_laboratory/config_packs/Raocow_talkhaus_full.zip" "raocow.zip"
        Pop $R0 ;Get the return value
          StrCmp $R0 "success" +3
            MessageBox MB_OK|MB_ICONSTOP "Download failed: $R0"
            Quit
	...
	Section "SMBX Redrawn Config Pack" SecRedrawn
		...
		SetOutPath "$INSTDIR\configs"
		;Download the file
		NSISdl::download "http://wohlsoft.ru/docs/_laboratory/config_packs/SMBX_Redrawn_full.zip" "redrawn.zip"
        Pop $R0 ;Get the return value
          StrCmp $R0 "success" +3
            MessageBox MB_OK|MB_ICONSTOP "Download failed: $R0"
            Quit
