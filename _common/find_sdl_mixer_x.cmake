...
function(find_mixer_x)
    ...
    if(_mixerx_STATIC)
        list(APPEND FOUND_LIBS SDLMixerXLibraryA)
    else()
        list(APPEND FOUND_LIBS SDLMixerXLibrarySO)
    endif()
    ...
    if(ANDROID)
        list(APPEND FOUND_LIBS SDL2LibrarySO)
    elseif(NOT SDL2_USE_SYSTEM)
        if(_mixerx_STATIC)
            list(APPEND FOUND_LIBS SDL2LibraryA)
        else()
            list(APPEND FOUND_LIBS SDL2LibrarySO)
        endif()
