...
if(HAIKU OR (UNIX AND NOT APPLE))
    add_definitions(-DMOONDUST_UNIX_INSTALL="${CMAKE_INSTALL_PREFIX}")
    add_definitions(-DMOONDUST_UNIX_SHARE_DIR="${PGE_INSTALL_DIRECTORY}")
endif()
