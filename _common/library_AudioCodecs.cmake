...
add_library(PGE_AudioCodecsEncode INTERFACE)
...
# Just an indication that AudioCodecs module is included
set(MOONDUST_AUDIO_CODECS TRUE)

if(NOT DEFINED AUDIOCODECS_ENABLE_ENCODERS)
    set(AUDIOCODECS_ENABLE_ENCODERS OFF)
endif()
...
# Generic list of libraries
set(AudioCodecs_Libs)
# The same list of libraries but with encoders included
set(AudioCodecs_Libs_Encode)
...
InstallTextFile(FILE "${CMAKE_SOURCE_DIR}/_Libs/AudioCodecs/FluidLite/LICENSE" RENAME "License.FluidLite.txt" DESTINATION "${PGE_INSTALL_LICS}" COMPONENT "MoondustLibs")
InstallTextFile(FILE "${CMAKE_SOURCE_DIR}/_Libs/AudioCodecs/libopus/COPYING" RENAME "License.Opus.txt" DESTINATION "${PGE_INSTALL_LICS}" COMPONENT "MoondustLibs")
InstallTextFile(FILE "${CMAKE_SOURCE_DIR}/_Libs/AudioCodecs/libopusfile/COPYING" RENAME "License.OpusFile.txt" DESTINATION "${PGE_INSTALL_LICS}" COMPONENT "MoondustLibs")
...
InstallTextFile(FILE "${CMAKE_SOURCE_DIR}/_Libs/AudioCodecs/libxmp/COPYING.LIB" RENAME "License.libXMP.txt" DESTINATION "${PGE_INSTALL_LICS}" COMPONENT "MoondustLibs")
InstallTextFile(FILE "${CMAKE_SOURCE_DIR}/_Libs/AudioCodecs/libADLMIDI/LICENSE" RENAME "License.libADLMIDI.txt" DESTINATION "${PGE_INSTALL_LICS}" COMPONENT "MoondustLibs")
InstallTextFile(FILE "${CMAKE_SOURCE_DIR}/_Libs/AudioCodecs/libOPNMIDI/LICENSE" RENAME "License.libOPNMIDI.txt" DESTINATION "${PGE_INSTALL_LICS}" COMPONENT "MoondustLibs")
InstallTextFile(FILE "${CMAKE_SOURCE_DIR}/_Libs/AudioCodecs/libEDMIDI/LICENSE.txt" RENAME "License.libEDMIDI.txt" DESTINATION "${PGE_INSTALL_LICS}" COMPONENT "MoondustLibs")
InstallTextFile(FILE "${CMAKE_SOURCE_DIR}/_Libs/AudioCodecs/libtimidity-sdl/COPYING" RENAME "License.Timidity.txt" DESTINATION "${PGE_INSTALL_LICS}" COMPONENT "MoondustLibs")
InstallTextFile(FILE "${CMAKE_SOURCE_DIR}/_Libs/AudioCodecs/libgme/license.gpl2.txt" RENAME "License.GME.txt" DESTINATION "${PGE_INSTALL_LICS}" COMPONENT "MoondustLibs")
