...
if(NOT APPLE)
    ...
    install(FILES ${MOONDUST_QT_LANG_BIN_FILES} DESTINATION "${PGE_INSTALL_DATA}/languages" COMPONENT "MoondustCommon")
    install(FILES ${MOONDUST_QT_LANG_ICON_FILES} DESTINATION "${PGE_INSTALL_DATA}/languages" COMPONENT "MoondustCommon")
endif()
