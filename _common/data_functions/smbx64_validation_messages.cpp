...
QString smbx64ErrMsgs(LevelData &lvl, int errorCode)
{
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 section\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 blocks\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Background Objects\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 NPC's\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Warps\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Water Boxes\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Layers\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Events\n"
    ...
    if(!message.isEmpty())
    {
        message=QObject::tr("A some issues are found on preparing to save SMBX64 Level file format:\n\n%1"
...
QString smbx64ErrMsgs(WorldData &wld, int errorCode)
{
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Tiles\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Sceneries\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Paths\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Levels\n"
    ...
    {
        message+=
        QObject::tr("SMBX64 standard isn't allows to save %1 Music Boxes\n"
    ...
    if(!message.isEmpty())
    {
        message=QObject::tr("A some issues are found on preparing to save SMBX64 World map file format:\n\n%1"
