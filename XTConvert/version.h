...
#ifdef XTCONVERT_VERSION_1
#   define V_VF1 XTCONVERT_VERSION_1
#else
#   define V_VF1 0
#endif

#ifdef XTCONVERT_VERSION_2
#   define V_VF2 XTCONVERT_VERSION_2
#else
#   define V_VF2 0
#endif

#ifdef XTCONVERT_VERSION_3
#   define V_VF3 XTCONVERT_VERSION_3
#else
#   define V_VF3 0
#endif

#ifdef XTCONVERT_VERSION_4
#   define V_VF4 XTCONVERT_VERSION_4
#else
#   define V_VF4 0
#endif

#ifdef XTCONVERT_VERSION_REL
#   define V_FILE_RELEASE STR_VALUE(XTCONVERT_VERSION_REL)
#else
...
#define V_FILE_DESC "Packer and converter of TheXTech content"

#define V_INTERNAL_NAME "XTConvert"

#ifdef _WIN32
    #define V_ORIGINAL_NAME "XTConvert.exe" // for Windows platforms
#else
    #define V_ORIGINAL_NAME "XTConvert" // for any other platforms
#endif
