...
<context>
    ...
    <message id="CRASH_UNHEXC_TITLE">
        ...
        <translation>Необработено изключение!</translation>
    </message>
    <message id="CRASH_UNHEXC_MSG">
        ...
        <translation>Двигателят се срина, защото е приел необработено изключение!</translation>
    </message>
    <message id="CRASH_OUT_OF_MEM_TITLE">
        <location filename="../common_features/crash_handler.cpp" line="386"/>
        <source>Out of memory!</source>
        <translation>Изчерпана памет!</translation>
    </message>
    <message id="CRASH_OUT_OF_MEM_MSG">
        ...
        <translation>Двигателят се срина поради липса на памет! Опитайте се да затворите други приложения и да рестартирате играта.</translation>
    </message>
    <message id="CRASH_TIMEOUT_TITLE">
        <location filename="../common_features/crash_handler.cpp" line="424"/>
        <source>Time out!</source>
        <translation>Времето изтече!</translation>
    </message>
    <message id="CRASH_TIMEOUT_MSG">
        ...
        <translation>Двигателят е прекъснал, защото alarm() времето за изчакване!</translation>
    </message>
    <message id="CRASH_BUS_TITLE">
        ...
        <translation>Грешка в адреса на физическата памет!</translation>
    </message>
    <message id="CRASH_BUS_MSG">
        ...
        <translation>Двигателят се е сринал поради грешка в адреса на физическата памет</translation>
    </message>
    <message id="CRASH_ILL_TITLE">
        ...
        <translation>Грешна инструкция на процесора!</translation>
    </message>
    <message id="CRASH_ILL_MSG">
        ...
        <translation>Двигателят се е сринал поради грешна инструкция на процесора</translation>
    </message>
    <message id="CRASH_FPE_TITLE">
        ...
        <translation>Грешна аритметична операция</translation>
    </message>
    <message id="CRASH_FPE_MSG">
        ...
        <translation>Двигателят се срина поради грешна аритметична операция!</translation>
    </message>
    ...
    <message id="CRASH_ABORT_TITLE.">
        ...
        <translation>Двигателят е прекъснат, защото е възникнала критична грешка.</translation>
    </message>
    <message id="CRASH_SIGSEGV_TITLE">
        ...
        <translation>Грешка при сегментирането</translation>
    </message>
...
and retry your recent actions to get more detailed information.</source>
        <translation>Двигателят се е сринал поради грешка в сегментацията.
Стартирайте отстраняване на грешки с вградено приложение в режим на отстраняване на грешки
и повторете последните си действия, за да получите по-подробна информация.</translation>
    </message>
    ...
    <message id="CRASH_INT_MSG">
        ...
        <translation>Двигателят е прекъснат</translation>
    </message>
    <message id="ERR_CONFIG_DIR_MISSING_TTL">
        ...
        <translation>Грешка в директорията на пакета за конфигуриране</translation>
    </message>
...
%1</source>
        <translation>Директорията за конфигуриране не е намерена на:
%1</translation>
    </message>
    <message id="ERR_CONFIG_ERROR_MAININI_TTL">
        ...
        <translation>Липсва main.ini</translation>
    </message>
    <message id="ERR_CONFIG_ERROR_MAININI_MSG">
        ...
        <translation>Не може да се отвори конфигурационния файл &apos;main.ini&apos;!</translation>
    </message>
    <message id="ERR_CONFIG_ERROR_DATADIR_TTL">
        ...
        <translation>Липсва директория с данни за конфигурационния пакет</translation>
    </message>
...
%1</source>
        <translation>Пътят за данни на конфигурационния пакет не съществува:
%1</translation>
    </message>
    <message id="WARNING_LEGACY_CONFIG_PACK_TTL">
        ...
        <translation>Пакет за наследствена конфигурация</translation>
    </message>
...
Играта ще бъде стартирана, но може да имате някои проблеми с геймплея.

Моля, изтеглете и инсталирайте най-новата версия на конфигурационния пакет:

Изтегляне: %1

Забележка: Повечето конфигурационни пакети са актуализации, включени в пакета PGE,
затова можете да използвате същата връзка, за да получите актуализирана версия.</translation>
    </message>
    <message id="ERROR_CONFIG_MAININI_FAILED_TTL">
        ...
        <translation>main.ini е невалиден</translation>
    </message>
    <message id="ERROR_CONFIG_MAININI_FAILED_MSG">
        ...
        <translation>Възникнала е грешка в main.ini в ред %1.</translation>
    </message>
...
configuration packages are not found!</source>
        <translation>Не може да се стартира играта, защото налични
конфигурационни пакети не са намерени!</translation>
    </message>
    <message id="CONFIG_SELECT_TEST">
        <location filename="../main.cpp" line="803"/>
        <source>Choose a game to test:</source>
        <translation>Изберете игра, която да тествате:</translation>
    </message>
    <message id="ERROR_NO_OPEN_FILES_MSG">
        <location filename="../main.cpp" line="295"/>
        <location filename="../main.cpp" line="480"/>
        <source>No opened files</source>
        <translation>Няма отворени файлове</translation>
    </message>
...
%1</source>
        <translation>ГРЕШКА:
Неуспешно стартиране на световната карта
...
%1</translation>
    ...
    <message id="WARNING_INCOMPATIBLE_WORLDMAP">
        ...
        <translation>Тази световна карта е несъвместима: Възможно е да получите неочаквани резултати от играта или грешки. Прегледайте дневника за подробности.</translation>
    </message>
    <message id="WLD_ERROR_LVLCLOSED">
        <location filename="../main.cpp" line="352"/>
        <source>World map was closed with error.
%1</source>
        <translation>Картата на света беше затворена с грешка.
%1</translation>
    </message>
...
%1</translation>
    ...
    <message id="WARNING_INCOMPATIBLE_LEVEL">
        ...
        <translation>Това ниво е несъвместимо: Възможно е да получите неочаквани резултати от играта или грешки. Прегледайте дневника за подробности.</translation>
    </message>
...
%1</translation>
    ...
    <message id="ERROR_LVL_UNKNOWN_PL_CHARACTER">
        ...
        <translation>Невалиден идентификатор на игрален герой</translation>
    </message>
    <message id="ERROR_LVL_UNKNOWN_PL_STATE">
        ...
        <translation>Невалиден идентификатор на състоянието на игралния герой</translation>
    </message>
    ...
    <message id="WLD_MENU_PAUSE_CONTINUESAVE">
        ...
        <translation>Запазване и продължаване</translation>
    </message>
    ...
    <message id="WLD_MENU_PAUSE_EXITNOSAVE">
        ...
        <translation>Излизане без запазване</translation>
    </message>
    ...
    <message id="MAINMENU_OPTIONS_TEST_SCRS">
        ...
        <translation>Изпитване на екрани</translation>
    </message>
    <message id="MAINMENU_OPTIONS_TEST_MSGS">
        ...
        <translation>Тест на кутиите за съобщения</translation>
    </message>
    <message id="MAINMENU_OPTIONS_CONTROLLS">
        ...
        <translation>Контрол на играча</translation>
    </message>
    ...
    <message id="MAINMENU_OPTIONS_MUS_VOL">
        ...
        <translation>Сила на звука на музиката</translation>
    </message>
    ...
    <message id="CONTROLLS_SETUP_PLAYER1">
        ...
        <translation>Контроли на играч 1</translation>
    </message>
    <message id="CONTROLLS_SETUP_PLAYER2">
        ...
        <translation>Контроли на играч 2</translation>
    </message>
...
Did you placed player start point (or entrance warp point) too far off of the section(s)?</source>
        <translation>Фатална грешка: Невъзможно е да се намери началната секция.
Дали сте поставили началната точка на играча (или входната уорп точка) твърде далеч от секцията(ите)?</translation>
    </message>
    ...
    <message id="LVL_MENU_PAUSE_REPLAY">
        ...
        <translation>Рестартиране на ниво</translation>
    </message>
...
Software renderer will be started.</source>
        <translation>Не може да се намери поддръжка на OpenGL!
Ще бъде стартиран софтуерен рендер.</translation>
    </message>
    <message id="NO_RENDERER_ERROR">
        <location filename="../graphics/window.cpp" line="189"/>
        <source>Renderer is not selected!</source>
        <translation>Не е избран рендерът!</translation>
    </message>
    <message id="WINDOW_CREATE_ERROR">
        ...
        <translation>Невъзможно е да се създаде прозорец!</translation>
    </message>
    <message id="WINDOW_ICON_INIT_ERROR">
        ...
        <translation>Не може да се настрои икона на прозорец!</translation>
    </message>
    <message id="RENDERER_CONTEXT_INIT_ERROR">
        ...
        <translation>Не може да се инициализира контекстът на рендера!</translation>
    </message>
    <message id="VSYNC_ERROR_INFO">
        ...
        <translation>Откритата скорост на кадрите е твърде висока. V-sync ще бъде изключен, за да се предотвратят проблемни резултати. Моля, включете го във вашия видео драйвер.</translation>
    </message>
