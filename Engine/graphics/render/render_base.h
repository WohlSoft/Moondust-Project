...
public:
    ...
    virtual int  alignToCenter(int x, int w) = 0;
    /*!
...
public:
    ...
    virtual PGE_Point MapToScr(PGE_Point) {return PGE_Point();}
    virtual PGE_Point MapToScr(int, int) {return PGE_Point();}
    virtual int  alignToCenter(int, int) {return 0;}
};
