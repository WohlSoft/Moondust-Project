...
{
    m_r = (float)((rgb & 0xFF0000)>>16)/255.0;
    m_g = (float)((rgb & 0x00FF00)>>8)/255.0;
    m_b = (float)((rgb & 0x0000FF)>>0)/255.0;
}

void GlColor::setRgba(GLuint rgba)
{
    m_r = (float)((rgba & 0xFF000000)>>24)/255.0;
    m_g = (float)((rgba & 0x00FF0000)>>16)/255.0;
    m_b = (float)((rgba & 0x0000FF00)>>8)/255.0;
    m_a = (float)((rgba & 0x000000FF))/255.0;
}
