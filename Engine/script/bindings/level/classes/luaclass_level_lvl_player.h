...
public:
    ...
    static void def_lua_onTakeNpc(LVL_Player* base, LVL_Npc*npc) { base->LVL_Player::lua_onTakeNpc(npc); }
    static void def_lua_onKillNpc(LVL_Player* base, LVL_Npc*npc) { base->LVL_Player::lua_onKillNpc(npc); }
    static void def_lua_onKeyPressed(LVL_Player* base, ControllableObject::KeyType ktype) { base->LVL_Player::lua_onKeyPressed(ktype); }
    static void def_lua_onKeyReleased(LVL_Player* base, ControllableObject::KeyType ktype) { base->LVL_Player::lua_onKeyReleased(ktype); }
