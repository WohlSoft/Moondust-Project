...
public:
    ...
    static void def_lua_onKill(LVL_Npc* base, KillEvent *killEvent) { base->LVL_Npc::lua_onKill(killEvent); }
    static void def_lua_onHarm(LVL_Npc* base, HarmEvent *harmEvent) { base->LVL_Npc::lua_onHarm(harmEvent); }
