#include "history_element_item_setting.h"
...
void HistoryElementItemSetting::processWorldUndo()
{
    ...
    {
        worldSearcher.setFindFilter(ItemTypes::WLD_S_ALL);
...
void HistoryElementItemSetting::processLevelUndo()
{
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_SLIPPERY)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_Block);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_Z_LAYER)
    {
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_Z_OFFSET)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_BGO);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_FRIENDLY)
    {
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_MESSAGE)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_DIRECTION)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_CHANGENPC)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_Block | ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_WATERTYPE)
    {
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_TWOWAY)
    {
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_GENTYPE)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_GENDIR)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_GENTIME)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_ATTACHLAYER)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_EV_DESTROYED)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_Block);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_EV_HITED)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_Block);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_EV_LAYER_EMP)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_Block | ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_EV_ACTIVATE)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_EV_DEATH)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_EV_TALK)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_SPECIAL_DATA)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_NPC);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_BGOSORTING)
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_BGO);
    ...
    else if(m_modLevelSetting == HistorySettings::SETTING_LVL_CUSTOM)
    {
...
void HistoryElementItemSetting::processLevelRedo()
{
    ...
    {
        levelSearcher.setFindFilter(ItemTypes::LVL_S_ALL_BASE);
