...
LvlSectionProps::LvlSectionProps(MainWindow *ParentMW, QWidget *parent) :
    QDockWidget(parent),
    ui(new Ui::LvlSectionProps)
{
    construct(ParentMW);
...
void LvlSectionProps::construct(MainWindow *ParentMW)
{
    mw=NULL;
...
void LvlSectionProps::setParentMW(MainWindow *ParentMW)
{
    mw = ParentMW;
}
