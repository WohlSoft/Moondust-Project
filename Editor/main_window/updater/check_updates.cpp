...
int UpdateChecker::str2ver(QString verSuffix)
{
...
QString UpdateChecker::compareVersions(QString ver1, QString ver2)
{
...
void UpdateChecker::httpFinished()
{
    ...
    else
    {
        ...
        case V_STABLE:
            ...
            qDebug()<< compareVersions(QString("%1").arg(_LATEST_STABLE), latest) << " win!" <<
            (( QString("%1").arg(_LATEST_STABLE) == compareVersions(QString("%1").arg(_LATEST_STABLE), latest))?"fresh":"old");
            if(QString("%1").arg(_LATEST_STABLE) == compareVersions(QString("%1").arg(_LATEST_STABLE), latest))
