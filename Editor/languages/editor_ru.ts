...
Официальный выпуск Moondust Devkit поддерживает только SMBX2 Beta4 и старее. Однако, вы по прежнему сможете использовать любой другой конфиг-пакет и запускать тестирование уровней с помощью движка SMBX2 снаружи.</translation>
    ...
    <message>
        ...
        <translation>Устаревший, несовместимый</translation>
    </message>
    <message>
        ...
        <translation>Несовместимый интеграционный</translation>
    </message>
    <message>
...
символы Юникода. Слишком длинные слова разбиваются принудительно,
...
Вы хотите сохранить изменения?</translation>
    ...
    <message>
        ...
        <translation>Версия файла SMBX-38A</translation>
    </message>
    <message>
...
version code must be less or equal specific code)</source>
        <translation>Какую версию вы хотите сохранить? (от 0 до 64)
Список известных версий SMBX-38A и кодов формата:
%1
(Чтобы уровень работал в указанной версии SMBX-38A,
номер версии должен быть меньше соответстующего кода)</translation>
    </message>
</context>
<context>
...
%2</translation>
    ...
    <message>
        ...
        <translation>Файл музыки не существует.</translation>
    </message>
    <message>
        <source>Notice: Music file is too heavy.</source>
        <comment>Tooltip music notice</comment>
        <translation>Замечание: Файл музыки слишком большой.</translation>
    </message>
    <message>
        <source>Notice: incompatible with vanilla engine.</source>
        <comment>Tooltip music notice</comment>
        <translation>Замечание: файл не совместимый с &quot;ванильным&quot; движком.</translation>
    </message>
    <message>
        <source>Notice: deprecated format</source>
        <comment>Tooltip music notice</comment>
        <translation>Замечание: устаревший формат</translation>
    </message>
    <message>
        <source>Custom music notice details</source>
        <comment>Custom music notice dialogue title</comment>
        <translation>Замечание к пользовательской музыке</translation>
    </message>
    <message>
        ...
        <translation>Файл музыки &quot;%1&quot; не существует. Пожалуйста, проверьте правильность пути к файлу. Вы можете использовать встроенный диалог выбора файлов с помощью кнопки &quot;...&quot; и выбрать корректный путь.</translation>
    </message>
    <message>
...
- Learn how to make looping music of different formats: &lt;a href=&quot;%2&quot;&gt;%2&lt;/a&gt;&lt;br/&gt;- List of supported music formats and other documentation can be found here: &lt;a href=&quot;%3&quot;&gt;%3&lt;/a&gt;</source>
        <comment>Custom music notice dialogue message</comment>
        <translation>Размер музыкальнго файла &quot;%1&quot; слишком большой. Пожалуйста, &lt;u&gt;не используйте т.н. &quot;расширенные версии&quot;&lt;/u&gt; игровой музыки и &lt;u&gt;не используйте несжатые форматы, такие как WAV или AIFF&lt;/u&gt;, иначе вы делаете свои уровни и эпизод несправедливо раздутыми. Не тратьте в пустую место на диске, какое может быть ограничено у пользователей.
&lt;br/&gt;&lt;br/&gt;
Пожалуйста, преобразуйте Вашу музыку во &lt;b&gt;FLAC&lt;/b&gt; или в &lt;b&gt;OGG Vorbis&lt;/b&gt;, а также начните исползовать точки цикла, чтобы бесконечно зациклить выбранную область в мелодии. Или даже лучше, если вы создадите или найдёте чиптюновую версию в исходном формате, например NSF, VGM, KSM, HES, GBS и т.п. Вы также можете использовать музыку в формате MIDI с помощью одного из встроенных MIDI-синтезаторов. Вы можете играть музыкаку как в стиле чиптюна, используя libADLMIDI, libOPNMIDI или libEDMIDI, или играть с помощью волновых банков формата SoundFont с помощью синтезатора FluidSynth по вашему желанию.
&lt;ul&gt;
&lt;li&gt;Узнать о том, как создавать зацикленную музыку в разных форматах: &lt;a href=&quot;%2&quot;&gt;%2&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;Список поддерживаемых форматов и связанная документация: &lt;a href=&quot;%3&quot;&gt;%3&lt;/a&gt;&lt;/li&gt;
&lt;/ul&gt;</translation>
    </message>
    <message>
...
- Learn how to make looping music of different formats: &lt;a href=&quot;%2&quot;&gt;%2&lt;/a&gt;&lt;br/&gt;- List of supported music formats and other documentation can be found here: &lt;a href=&quot;%3&quot;&gt;%3&lt;/a&gt;</source>
        <comment>Custom music notice dialogue message</comment>
        <translation>Ваш музыкальный файл &quot;%1&quot;, вероятно, использует один из &lt;b&gt;устаревших форматов&lt;/b&gt;. Данные форматы являются частым источником низкого качества звучания и раздутых пакетов. Также у этих форматов отсутствуют многие полезные функции, такие как &lt;u&gt;точки зацикливания&lt;/u&gt;.
&lt;br/&gt;&lt;br/&gt;
Пожалуйста, рассмотрите другие форматы музыки. Для цифрового аудио лучше всего подходит формат &lt;b&gt;OGG Vorbis&lt;/b&gt;, благодаря отличному качеству звучания при сильной степени сжатия, а также данный формат позволяет использовать точки зацикливания, с помощью которых можно обозначить, какая часть композиции будет бесконечно зациклена.
&lt;br/&gt;&lt;br/&gt;
Также вы можете штатно использовать &lt;b&gt;чиптюны&lt;/b&gt; (NSF, HES, VGM, HES, GBS, и т.п.) или &lt;b&gt;трекерные форматы&lt;/b&gt; (MOD, IT, XM, S3M, и т.п.). Дополнительно можно также использовать &lt;b&gt;музыку в MIDI-формате&lt;/b&gt; с гибкой возможностью звучания, как в стиле чиптюна (с помощью синтезаторов libADLMIDI, libOPNMIDI или libEDMIDI), либо в волновом стиле с помощью банков формата SoundFont, используя синтезатор FluidSynth.
&lt;ul&gt;
&lt;li&gt;Узнать о том, как создавать зацикленную музыку в разных форматах: &lt;a href=&quot;%2&quot;&gt;%2&lt;/a&gt;&lt;/li&gt;
&lt;li&gt;Список поддерживаемых форматов и связанная документация: &lt;a href=&quot;%3&quot;&gt;%3&lt;/a&gt;&lt;/li&gt;
&lt;/ul&gt;</translation>
    ...
    <message>
        ...
        <comment>Custom music notice dialogue message</comment>
        <translation>Ваш музыкальный файл &quot;%1&quot;, вероятно, не совместим с исходным SMBX-движком. Вы видите данное преждупреждение потому, что редактируете файл устаревшего формата. Если вы не целитесь на исходный движок, вы можете проигнорировать данное предупреждение. Исходный SMBX-движок поддерживает только &lt;b&gt;MP3&lt;/b&gt;, &lt;b&gt;WAV&lt;/b&gt;, &lt;b&gt;WMA&lt;/b&gt; и &lt;b&gt;MID&lt;/b&gt; без строки аргументов.</translation>
    </message>
</context>
<context>
