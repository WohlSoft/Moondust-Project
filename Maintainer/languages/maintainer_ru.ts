...
<context>
    ...
    <message>
        ...
        <translation>Файлы будут в том же формате</translation>
    </message>
    <message>
...
Please set SoX path first</source>
        <translation>Путь к исполняемому файлу SoX не уканан
...
Please set SoX path first</source>
        <translation>Неверный путь к исполняемому файлу SoX.
Пожалуйста, укажите путь к SoX</translation>
    </message>
    <message>
...
Преобразовано файлов: %1
Перезаписано уровней: %2
Перезаписано карт мира: %3
%4</translation>
    </message>
    <message>
        <location filename="../Music/audiocvt_sox_gui.cpp" line="503"/>
    ...
    <message>
        ...
        <translation>Выбрать путь к исполняемому файлу FFMPEG</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Преобразователь эпизодов</translation>
    </message>
    <message>
...
- SMBX-38A</source>
        <translation type="vanished">Этот мастер поможет преобразовать/починить файлы уровней и эпизодов между разными форматами
Поддерживаемые форматы:
- PGE-X LVLX/WLDX
- SMBX версии 1...64 LVL/WLD
- SMBX-38A</translation>
    ...
    <message>
        ...
        <translation>Сделать резервную копию (в подпапках &quot;pge_maintainer_backup-*&quot;)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">[Выберите движок]</translation>
    </message>
    <message>
        <source>Moondust Engine</source>
        <translation type="vanished">Движок Moondust</translation>
    </message>
    <message>
...
This option is only works if you convert episode for TheXTech.</source>
        <translation>Если вы преобразуете старые эпизоды, созданные для SMBX версии старее, чем 1.3,
то вам помогут особые настройки НИП, которые переведут их в режим оригинального поведения.

Данная опция работает только тогда, когда эпизод преобразуется для TheXTech.</translation>
    </message>
    <message>
        ...
        <translation>Применить настройки в режиме &quot;пред-1.3&quot; НИП для TheXTech</translation>
    </message>
    <message>
        ...
        <translation>Выберите движок, для которого вы собираетесь преобразовать эпизод:</translation>
    </message>
    <message>
...
Important: There are only level and world map files gets being converted. Any including graphics, scripts, configs, music, etc. will not be touched at all.</source>
        <translation>Данный мастер поможет преобразовать эпизод между разными форматами, либо попытаться исправить повреждения.

Важно: Преобразуются только файлы уровней и карт мира. Всё прочее, включая графику, сценарии, настройки, музыку, и т.п. останется как есть не тронутым.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">Сделать резервную копию (в подпапках &quot;_backup&quot;)</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>&lt;Не эпизод, и даже не набор уровней&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Уровень(вни) без эпизода, формат: %1</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Преобразовать GIF с масками в PNG</translation>
    </message>
    <message>
        <location filename="../Graphics/gifs2png.ui" line="109"/>
        <source>Convert files</source>
        <translation>Преобразовать файлы</translation>
    </message>
    <message>
        ...
        <translation>Перетащите сюда GIF-файлы с масками, чтобы преобразовать их в PNG</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Этот мастер поможет вам автоматически исправить любую графику для SMBX 1.3 (в формате GIF с использованием битовой маски), у которой неправильно спроектированные маски (то есть, сделанные с ленью). Маски, сделанные с ленью - это маски, созданные путем копирования лицевого изображения и заливки фона белым цветом. Этот метод создания масок лишь создаёт иллюзию быстрой работы: на самом деле, эти маски некорректны, и именно они становятся причиной различных странных глюков в некоторых графических движках и конвертерах. После обработки таких изображений, все недопустимые маски будут преобразованы в корректную форму с чёрным силуэтом и белым фоном, какими они и должны быть, и, следовательно, их можно будет использовать везде и всюду, не боясь каких либо глюков.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Вспомогательный набор: главное меню</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Преобразователи</translation>
    </message>
    <message>
        ...
        <translation>Преобразовать аудио между разными форматами, а также преобразовывать частоты дискретизации</translation>
    </message>
    <message>
        <location filename="../main_window.ui" line="76"/>
        <source>Batch conversion of musics</source>
        <translation>Массовое преобзование музыки</translation>
    </message>
    <message>
        ...
        <translation>Преобразование уровней и эпизодов между разными форматами, а также попытка исправить старые файлы с некоторым повреждением.</translation>
    </message>
    <message>
        <location filename="../main_window.ui" line="92"/>
        <source>Levels and Episodes format converting/fixing</source>
        <translation>Преобразование и ремонт форматов Уровней и Эпизодов</translation>
    </message>
    <message>
        ...
        <translation>Преобразование графики из формата GIF-пары (перед и маска) в PNG с полупрозрачностью.</translation>
    </message>
    <message>
        <location filename="../main_window.ui" line="108"/>
        <source>GIFs to PNG converter</source>
        <translation>Преобразовать SMBX64-GIFы в PNG</translation>
    </message>
    <message>
        ...
        <translation>Преобразование обычных PNG-файлов в GIF-пару (перед и маска), совместимую с алгоритмом битовой маски (требуется для устаревшего движка SMBX).</translation>
    </message>
    <message>
        <location filename="../main_window.ui" line="124"/>
        <source>PNG to GIFs converter</source>
        <translation>Преобразовать PNG в SMBX64-GIFы</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Исправляет несоответствия регистра букв в путях в файловой системе и в упоминаниях в уровнях, картах мира, а также некоторых настроечных файлах.</translation>
    </message>
    <message>
        <location filename="../main_window.ui" line="172"/>
        <source>Fix case sensitive paths compatibility</source>
        <translation>Починить совместимость регистрозависимых путей</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Преобразовать PNG в GIF с масками</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Перетащите сюда PNG-файлы, чтобы преобразовать их в GIFы с масками</translation>
    </message>
    <message>
