...
<context>
    ...
    <message>
        ...
        <translation>Этот мастер поможет вам автоматически исправить любую графику SMBX 1.3 (в формате GIF с использованием битовой маски), у которой неверно спроектированная маска (например, сделанная с ленью). Маски, сделанные с ленью - это маски, созданные путем копирования лицевого изображения и заливки фона белым цветом. Этот метод создания масок дает иллюзию быстрой работы, однако эти маски недействительны и могут вызывать странные сбои в некоторых графических движках и конвертерах. После обработки этих спрайтов все недопустимые маски будут преобразованы в допустимую форму черной формы, какой они должны быть, и, следовательно, их можно будет свободно использовать везде без сбоев.</translation>
    </message>
    <message>
