...
- SMBX-38A</source>
        <translation>Этот мастер поможет преобразовать/починить файлы уровней и эпизодов между разными форматами
...
<context>
    ...
    <message>
        ...
        <translation>Этот мастер поможет автоматически исправить графику для SMBX 1.3 (в формате GIF с использованием битовой маски), которая содержит неправильно сделанные маски (т.н. сделанные с ленью). Маски, сделанные с ленью, это маски, созданные путём копирования переднего изображения и заливкой фона вокруг силуэта белым, сохраняя сам силуэт идентичным переднему изображению. Такой метод создания масок создаёт лишь иллюзию быстрой работы: на самом деле, такие маски являются некорректными, и именно они становятся причиной различных глюков на некоторых графических движках и конверторах. После обработки таких изображений, все неправильные маски будут превращены в корректную форму чёрного силуэта с белым фоном как они должны быть, и следовательно, их можно будет использовать везде и всюду, не боясь каких либо глюков.</translation>
    </message>
    <message>
