...
extern void OPNMIDI_setInfiniteLoop(struct MUSIC_MIDIOPN *music, int loop);
...
extern void OPNMIDI_setvolume(struct MUSIC_MIDIOPN *music, int volume);

/* Load a ADM MIDI stream from an SDL_RWops object */
extern struct MUSIC_MIDIOPN *OPNMIDI_new_RW(SDL_RWops *rw, int freerw);

/* Start playback of a given ADM MIDI stream */
extern void OPNMIDI_play(struct MUSIC_MIDIOPN *music);

/* Return non-zero if a stream is currently playing */
extern int OPNMIDI_playing(struct MUSIC_MIDIOPN *music);

/* Play some of a stream previously started with OPNMIDI_play() */
extern int OPNMIDI_playAudio(struct MUSIC_MIDIOPN *music, Uint8 *stream, int len);

/* Stop playback of a stream previously started with OPNMIDI_play() */
extern void OPNMIDI_stop(struct MUSIC_MIDIOPN *music);

/* Close the given ADM MIDI stream */
extern void OPNMIDI_delete(struct MUSIC_MIDIOPN *music);

/* Jump (seek) to a given position (time is in seconds) */
extern void OPNMIDI_jump_to_time(struct MUSIC_MIDIOPN *music, double time);
